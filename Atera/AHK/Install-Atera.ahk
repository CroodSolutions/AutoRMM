; AHK v2 
; See Readme.md
; AHK Script to test installation of Atera RMM MSI via AHK.
...
ConsoleOutput("Downloading Atera agent installer...")
...
ConsoleOutput("Installing Atera agent silently...")
exitCode := RunWait('msiexec /i "' downloadPath '" /qn /norestart', , "Hide")

if (exitCode = 0)
{
    MsgBox("Atera agent installed successfully.", "Success", 64)
}
