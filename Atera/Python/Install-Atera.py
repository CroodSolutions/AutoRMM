#!/usr/bin/env python3
"""
This is an install script for Atera RMM, using Python 3.
...
def main():
    # Configuration
    installer_name = "Atera_agent(My_Organization).msi"
    ...
    if download_url == "(Paste Install URL here)":
        show_message("Configuration Error", 
                    "Please update the download_url variable with your actual Atera download URL.", 
                    "error")
        sys.exit(1)
    ...
    if exit_code == 0:
        show_message("Installation Complete", 
                    "Atera agent has been installed successfully.", 
                    "info")
    elif exit_code == 3010:
