...
' This is an install script for Atera RMM, using VBS.
' Our intention for this, is to build toward delivery options via VBA for red/purple team testing.
...
' 1) Define file & URL
installerName = "Atera_agent(My_Organization).msi"
...
WScript.Echo "Downloading Atera agent installer..."
...
WScript.Echo "Installing Atera agent silently..."
...
Select Case exitCode
    Case 0
        MsgBox "Atera agent installed successfully.", vbInformation, "Success"
    Case 3010
